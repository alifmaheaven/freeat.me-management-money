...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        $transaction = DB::table('transaction')
            ->select('transaction.id','transaction.name', 'transaction.description', 'transaction.nominal', 'transaction.date', 'type.name as typename', 'type.is_minus', 'account.name as accountname')
